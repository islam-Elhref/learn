...
3. Go to install directory product JetBrains ( Example : C:\Program Files\JetBrains\PhpStorm 2021.3\bin ) find *.exe.vmoptions ( Example : phpstorm64.exe.vmoptions ) open with Notepad++ add end line & Save:
